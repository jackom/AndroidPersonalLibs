...
public final class EncryptUtils {
    ...
    public static final String TAG = EncodeUtils.class.getSimpleName();
    ...
    public static byte[] decryptHexStringDES(final String data,
                                             ...
                                             final String transformation,
                                             final byte[] iv) {
        byte[] hexString2Bytes = hexString2Bytes(data);
        if (hexString2Bytes.length <= 0) {
            return new byte[0];
        }
        return decryptDES(hexString2Bytes, key, transformation, iv);
    }
    ...
    public static byte[] decryptHexString3DES(final String data,
        ...
        return decrypt3DES(hexString2Bytes, key, transformation, iv);
    }
    ...
    public static byte[] decryptHexStringAES(final String data,
        ...
        return decryptAES(hexString2Bytes, key, transformation, iv);
    }
    ...
    public static byte[] decryptHexStringRSA(final String data,
        ...
        return decryptRSA(hexString2Bytes, privateKey, keySize, transformation);
    }
    ...
    public static byte[] hexString2Bytes(String hexString) {
        ...
        for (int i = 0; i < len; i += 2) {
            if ((hex2Dec(hexBytes[i]) == -1) || (hex2Dec(hexBytes[i]) == -1)) {
                return new byte[0];
            }
...
//            LogUtils.e(TAG, "hex2Dec error" + hexChar);
